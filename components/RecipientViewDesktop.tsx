        ...
        <div className="flex flex-col h-full bg-slate-50">
            ...
            <div className="bg-white border-b border-slate-200 px-6 py-4 flex items-center gap-4 shrink-0">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-lg font-black text-slate-800 tracking-tight leading-none">Cara Order Tracking</h1>
                        <p className="text-[10px] font-bold text-slate-400 uppercase tracking-tighter mt-0.5">Portal powered by Alphalake Ai</p>
                    </div>
                </div>
            </div>
                ...
                <div className="flex-1 flex flex-col overflow-hidden">
                    <AnimatePresence mode="wait">
                        {view === 'HOME' && (
                            ...
                            >
                                {/* Page Header - Now inside content */}
